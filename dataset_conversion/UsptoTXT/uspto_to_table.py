...
if __name__ == "__main__":
    ...
    input_file = '/Users/zhaodongliu/Documents/GitHub/NLP_project/retro0.txt'          # 原始 SMILES 文件路径
    final_output = '/Users/zhaodongliu/Documents/GitHub/NLP_project/0000.txt' # 最终输出文件路径
